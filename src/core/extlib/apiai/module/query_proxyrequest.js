...
exports.QueryProxyRequest = module.exports.QueryProxyRequest = QueryProxyRequest;

util.inherits(QueryProxyRequest, ProxyRequest);

function QueryProxyRequest (application, options) {
    var self = this;
    ...
    QueryProxyRequest.super_.apply(this, arguments);
}

QueryProxyRequest.prototype._requestOptions = function() {
    var self = this;
    ...
    var request_options = QueryProxyRequest.super_.prototype._requestOptions.apply(this, arguments);
...
QueryProxyRequest.prototype._requestOptions2 = function () {
    ...
    var request_options = QueryProxyRequest.super_.prototype._requestOptions2.apply(this, arguments);
...
QueryProxyRequest.prototype._jsonRequestParameters = function() {
    var self = this;
