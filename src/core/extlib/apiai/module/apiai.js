...
var TextProxyRequest = require('./text_proxyrequest').TextProxyRequest;
...
Application.prototype.textProxyRequest = function (query, options) {
    var self = this;
    var opt = options || {};
    ...
    return new TextProxyRequest(self, query, opt);
};
